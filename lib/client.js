window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const SETTINGS_NAMESPACE = "node-accent";
		/** 配色规则样式标签的标记属性. */
		...
		*/
		function decodeNodeAccentSettings(section) {
			...
			if (typeof configuredTools === "object" && configuredTools !== null) {
				for (const [tool, value] of Object.entries(configuredTools)) if (typeof value === "string" && isCssColor(value)) toolColors[tool] = value;
			}
			return {
				paintIcon: raw[PAINT_ICON_FIELD] !== false,
				paintTitle: raw[PAINT_TITLE_FIELD] !== false,
				colors: resolveColors({ colors: raw[COLORS_FIELD] }),
				toolColors
			};
		}
		//#endregion
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: "改动即时生效. 与 dsh-node-appearance 不能同时启用."
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
